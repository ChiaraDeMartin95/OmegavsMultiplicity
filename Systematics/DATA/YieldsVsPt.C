...
void YieldsVsPt(
    ...
    TString SPathIn = "results/Data-LHC22oapass4.root",
    TString SPathInEvt = "data/526641/AnalysisResults_TOT.root",
...
)
{
  ...
  /*SPathIn += "_" + sysname + "_" + SpartType[part];
  if (isSysStudy)
    SPathIn += SysPath;
  SPathIn += ".root";

  SPathInEvt += "_" + sysname;
  if (SysPath.find("_Train109827") != string::npos)
    SPathInEvt += "_AllRuns";
  SPathInEvt += StringPathInEvt;
  // SPathInEvt += "_run528531";
  SPathInEvt += ".root";*/ //commented by Francesca
